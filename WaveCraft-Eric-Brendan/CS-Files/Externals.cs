 ...
 * File: Externals.cs
 *
 * Purpose: Contains the external method declarations for interacting with the WaveCraftExternals.dll and other libraries for audio processing.
 *
 ***********************************************************************************************************************************************************/
...
{
    /*
    * Provides external method declarations for interacting with the WaveCraftExternals.dll and other libraries for audio processing.
    */
    public class Externals
    {

        // WaveCraftExternals.dll method declarations.
         ...
         */
        [DllImport("WaveCraftExternals.dll")]
        ...
        */
        [DllImport("WaveCraftExternals.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr getConfig();

        /*
        * Creates the invisible recording interface.
        * @param hwnd The window handle.
        */
        [DllImport("WaveCraftExternals.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern void RecordDialog(IntPtr hwnd);
